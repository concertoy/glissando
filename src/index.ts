...
export type { TextRun, TextRunOpts, BulletOpts, AddTextOpts, AddShapeOpts, AddImageOpts, AddTableOpts, TableCell, TransitionOpts, TransitionType, GradientFill, GradientStop, FillOpts, LineOpts, ShadowOpts } from "./ooxml/index.js";
